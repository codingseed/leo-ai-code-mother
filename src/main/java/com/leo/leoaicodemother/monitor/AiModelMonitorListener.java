package com.leo.leoaicodemother.monitor;
...
public class AiModelMonitorListener implements ChatModelListener {
    ...
    public void onRequest(ChatModelRequestContext requestContext) {
        ...
        if (monitorContext != null) {
            userId = monitorContext.getUserId();
            appId = monitorContext.getAppId();
    ...
    private void recordResponseTime(Map<Object, Object> attributes, String userId, String appId, String modelName) {
        if (attributes != null && attributes.containsKey(REQUEST_START_TIME_KEY)) {
    ...
    private void recordTokenUsage(ChatModelResponseContext responseContext, String userId, String appId, String modelName) {
        if (responseContext != null && responseContext.chatResponse() != null && 
