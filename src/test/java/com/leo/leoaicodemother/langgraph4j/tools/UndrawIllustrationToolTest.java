package com.leo.leoaicodemother.langgraph4j.tools;

import com.leo.leoaicodemother.langgraph4j.model.ImageResource;
import com.leo.leoaicodemother.langgraph4j.model.enums.ImageCategoryEnum;
...
class UndrawIllustrationToolTest {
    ...
    void testSearchIllustrations() {
        ...
        assertFalse(illustrations.isEmpty(), "列表不应为空");
        // 验证返回的插画资源
